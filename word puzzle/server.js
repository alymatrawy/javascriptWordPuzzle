...
http.createServer(function(request, response) {
 ...
 //================================(getting puzzle to display on screen)=================================
    ...
    //================================(handling solution)=================================
    else if(request.method === "POST" && urlObj.pathname === "/solvePuzzle"){
      let solution=''

      let puzzleFile = `puzzles/${dataObj.name}.txt`
      console.log(`Looking for puzzle file: ${puzzleFile}`)
        ...
        if (err) {
          ...
          for (i in fileLines){
            fileLines[i] = fileLines[i].replaceAll(/(\r\n|\n|\r)/gm, "")
              ...
              solution+=fileLines[i]
          }

          solution = solution.replaceAll(" ", "")
          dataObj.solution  = dataObj.solution.replaceAll(" ", "")


          if(solution.toLowerCase()===dataObj.solution.toLowerCase()){
            returnObj.text = "correct"
          }

          else{
            returnObj.text = "wrong"
          }
